...
export default function SamplerAdmin({ trackId, samplerTrack }: Props) {
  ...
  const currentSample =
    samplerTrack.samplerTrack?.sampleUrl?.split("/").pop() ||
    "No sample loaded";
        ...
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex-1 bg-zinc-900 border border-neutral-700 overflow-auto text-sm">
            <div className="divide-y divide-neutral-800">
              {samplerTrack.samplerTrack?.sampleUrl ? (
                <div className="flex items-center justify-between px-4 py-3 hover:bg-neutral-800">
